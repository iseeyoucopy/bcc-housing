...
Locales["de_lang"] = {
    ...
    manageConfigHouses = 'Config-Häuser verwalten',
    configHouseTpLabel = 'TP: %s | Eindeutiger Name: %s',
    noConfigHouses = 'Keine konfigurierten Häuser gefunden.',
    configHouseCoordsMissing = 'Konfiguriertes Haus %s hat keine Teleport-Koordinaten.',
    configHouseTeleported = 'Zum konfigurierten Haus %s teleportiert.',
